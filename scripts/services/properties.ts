...
export const properties: T.ExpectedExports.properties = async (
  ...
  const paths = [
    "start9/controlTorAddress",
    "start9/peerTorAddress",
    "start9/admin.macaroon.hex",
    "start9/admin.macaroon.base64url",
    "start9/control.cert.pem.base64url",
  ];
