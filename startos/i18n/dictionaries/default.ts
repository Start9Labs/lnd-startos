...
const dict = {
  ...
  'Choose how to initialize your LND wallet. Start Fresh creates a new wallet. Migrate from Umbrel or StartOS pulls an existing wallet from the old device over your local network. Migrate Manually adopts LND data you have already copied into place.': 207,
  'Start Fresh': 208,
  'Migrate from Umbrel': 209,
  'Migrate Manually': 284,
  'Wallet Password': 285,
  "The password that unlocks the wallet you copied — your old node's LND wallet password.": 286,
  'Successfully imported the copied LND data. WARNING: Never start your old node again with the same wallet. Running two LND nodes with the same seed will lead to unpredictable behavior or loss of funds.': 287,
