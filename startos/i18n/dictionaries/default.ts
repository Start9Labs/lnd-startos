...
const dict = {
  ...
  'Maximum fee': 565,
  'The most this node may pay in routing fees, as a percentage of the amount.': 566,
  'The invoice could not be decoded: ${error}': 567,
  'This invoice carries no amount; select "Enter an amount".': 568,
  'Payment failed: ${reason}': 569,
  'Payment sent': 570,
  'Paid ${amount} sats to ${destination}.': 571,
  Amount: 572,
  Fee: 573,
  Description: 574,
  Destination: 575,
  ...
  'Enter an amount': 577,
  'Amount to pay': 578,
  'This invoice already carries an amount of ${amount} sats; select "As stated in the invoice".': 579,
  Payments: 580,
  'Receive Payment': 581,
  'Create a Lightning invoice for this node to be paid.': 582,
  'Leave empty to let the payer choose the amount.': 583,
  'Shown to the payer in their wallet.': 584,
  'Expires in': 585,
  'The invoice could not be created: ${error}': 586,
  'Invoice created': 587,
  'Payable for ${hours} hours.': 588,
  'Any amount': 589,
  'Payment hash': 590,
} as const
