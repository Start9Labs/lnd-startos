...
const dict = {
  ...
  'LND is starting…': 9,
  'Bitcoin is not serving blocks to LND: ${error}': 599,
  'timed out': 600,
  'LND Is Not Seeing New Blocks': 601,
  'Bitcoin is not serving blocks to LND, so LND cannot see new blocks or respond in time to a channel breach or an expiring HTLC. Check the Bitcoin service. Last error: ${error}': 602,
  ...
  'A StartOS backup only holds the channels you had when you took it. A continuous backup stays current.': 379,
  'Continuous Backup': 380,
  'No continuous backup target. channel.backup travels only inside the StartOS backups you take yourself, so channels opened since your last one are not covered.': 381,
  ...
  'No backup target is enabled. Run Configure Continuous Backups first.': 456,
  ...
  'Continuous backups are unavailable while LND is preparing imported data. Try again after LND starts normally.': 488,
  'SFTP: the host must not begin with "-".': 489,
  'A restore is in progress. channel.backup is not sent until it completes.': 491,
  'A backup target has not answered, so the channel.backup it holds has not been restored yet: ${detail} To stop waiting for it, clear its saved credentials in Configure Continuous Backups.': 492,
  'Cold Storage': 493,
  ...
  'Pay Invoice': 562,
  'Pay a Lightning invoice from this node.': 563,
  Invoice: 564,
  'A Lightning invoice.': 565,
  'As stated in the invoice': 566,
  'Most invoices state their amount; enter one only when the invoice leaves it open.': 567,
  'Maximum fee': 568,
  'The most this node may pay in routing fees, as a percentage of the amount.': 569,
  'The invoice could not be decoded: ${error}': 570,
  'This invoice carries no amount; select "Enter an amount".': 571,
  'Payment failed: ${reason}': 572,
  'Payment sent': 573,
  'Paid ${amount} sats to ${destination}.': 574,
  Amount: 575,
  Fee: 576,
  Description: 577,
  Destination: 578,
  ...
  'Enter an amount': 580,
  'Amount to pay': 581,
  'This invoice already carries an amount of ${amount} sats; select "As stated in the invoice".': 582,
  Payments: 583,
  'Receive Payment': 584,
  'Create a Lightning invoice for this node to be paid.': 585,
  'Leave empty to let the payer choose the amount.': 586,
  'Shown to the payer in their wallet.': 587,
  'Expires in': 588,
  'The invoice could not be created: ${error}': 589,
  'Invoice created': 590,
  'Payable for ${hours} hours.': 591,
  'Any amount': 592,
  'Payment hash': 593,
  'Amountless invoice to ${destination}; enter the amount below.': 594,
  'Invoice details: ${amount} sats to ${destination}.': 595,
  'I verified the amount and destination': 596,
  'Confirm these details before sending. Lightning payments cannot be reversed.': 597,
