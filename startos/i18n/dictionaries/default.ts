...
const dict = {
  ...
  'From Google Cloud Console.': 325,
  'Authorization Code': 326,
  'From the OAuth redirect: the code= value, or the whole URL.': 327,
  'Refresh Token': 328,
  'Paste an existing token, or leave blank to generate one from the authorization code.': 329,
  'Folder Path': 330,
  ...
  Password: 341,
  'An app password (Settings, then Security).': 342,
  'Trust self-signed certificate': 343,
  'Skip certificate verification for this server. Turn this on only for a Nextcloud on your own network using a self-signed certificate. channel.backup is encrypted by LND before it leaves this server either way.': 344,
  ...
  'SSH Key': 355,
  'Private Key': 356,
  'The whole OpenSSH private key, including its BEGIN and END lines.': 357,
