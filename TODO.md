...
| Key                     | Written while                    |
| ----------------------- | -------------------------------- |
| `bitcoind:config`       | 2025-05-23 → 2025-12-12          |
| `bitcoind:other-config` | 2025-12-12 → 2026-03-02          |
| `bitcoind:autoconfig`   | 2026-03-02 → now — live, keep it |
...
not a guarantee — change what LND asks bitcoind for and the keys become mutually exclusive,
leaving the user ping-ponging between tasks with no way to settle. That is exactly what
happened to datum-gateway, whose stale `bitcoind:other-config` fought its live
